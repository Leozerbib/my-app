    ...
    <div className="space-y-8">
      ...
      <Card className="relative overflow-hidden rounded-xl p-6 bg-gradient-to-br from-white to-gray-50 shadow-xl hover:shadow-2xl transition-all duration-300">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-blue-800">Les Chiffres Clés</h2>
          <h3 className="text-xl font-semibold text-blue-600">"En Quelques Chiffres"</h3>
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="font-semibold">Coût Unitaire</h4>
              <p className="text-2xl font-bold text-blue-600">150€</p>
              <p className="text-sm">Prix de vente: 275€</p>
            </div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              <h4 className="font-semibold">Objectif Ventes</h4>
              <p className="text-2xl font-bold text-purple-600">30 000</p>
              <p className="text-sm">unités en An 1</p>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6 bg-white shadow-lg">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-blue-800">Analyse des Opportunités</h2>
          <h3 className="text-xl font-semibold text-blue-600">"Stratégie d'Entrée sur le Marché"</h3>
      ...
      <Card className="p-6 bg-white shadow-lg">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-blue-800">Modèle Économique</h2>
          <h3 className="text-xl font-semibold text-blue-600">"Plan Financier"</h3>
