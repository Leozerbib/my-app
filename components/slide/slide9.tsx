      ...
      <Card className="relative overflow-hidden rounded-xl p-6 bg-gradient-to-br from-white to-gray-50  shadow-xl hover:shadow-2xl transition-all duration-300">
        <div className="space-y-4 h-full w-full">
          ...
          <div className="grid grid-cols-2 gap-8 mt-8">
            <div className="p-6 bg-blue-50 hover:bg-blue-100 rounded-lg text-center transform hover:scale-105 transition-transform">
            ...
            <div className="p-6 bg-green-50 hover:bg-green-100 rounded-lg text-center transform hover:scale-105 transition-transform">
            ...
            <div className="p-6 bg-purple-50 hover:bg-purple-100 rounded-lg text-center transform hover:scale-105 transition-transform">
            ...
            <div className="p-6 bg-orange-50 hover:bg-orange-100 rounded-lg text-center transform hover:scale-105 transition-transform">
